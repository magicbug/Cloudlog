...
class Migration_add_file_manager extends CI_Migration
{
	public function up()
	{
		...
		$this->db->query("INSERT INTO file_manager (id, name, driver, url_prefix, cfg_1, cfg_2, cfg_3, cfg_4, cfg_5, cfg_6) VALUES (1, 'default', 'local', ?, './assets/qslcard/', NULL, NULL, NULL, NULL, NULL);", array($url_prefix));
		$this->db->query("INSERT INTO `options` (option_id, option_name, option_value, autoload) VALUES (NULL, 'default_file_manager_id', '1', 'yes');");
