...
class Station extends CI_Controller {
	...
	public function index()
	{
		...
		// Render Page
		$data['page_title'] = lang('station_loc');
	...
	public function create() {
		...
		{
			$data['page_title'] = lang('station_loc_create_header');
			$this->load->view('interface_assets/header', $data);
	...
	public function edit($id) {
		...
		if ($this->stations->check_station_is_accessible($id)) {
			...
			$data['page_title'] = lang('station_loc_edit') . $data['my_station_profile']->station_profile_name;
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$data['notice'] = lang('station_loc') . $this->security->xss_clean($this->input->post('station_profile_name', true)) . " Updated";
