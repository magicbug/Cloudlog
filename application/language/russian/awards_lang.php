...
$lang['awards_menu_settings'] = "Настройки наград";
$lang['awards_info_button'] = "Информация о награде";
...
$lang['awards_wab_filter_band'] = "Диапазон";
$lang['awards_wab_filter_mode'] = "Режим";
$lang['awards_wab_filter_confirmed_only'] = "Показывать только подтверждённые";
$lang['awards_wab_stat_worked'] = "Отработанные квадраты (отфильтрованы)";
$lang['awards_wab_stat_confirmed'] = "Подтверждённые квадраты (отфильтрованы)";
$lang['awards_wab_tab_map'] = "Карта";
$lang['awards_wab_tab_table'] = "Таблица";
$lang['awards_wab_table_heading'] = "QSO в поле зрения";
$lang['awards_wab_no_qsos'] = "Нет QSO, соответствующих текущим фильтрам.";
$lang['awards_wab_action_reset'] = "Сброс";
