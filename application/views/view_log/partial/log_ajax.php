...
function echo_table_col($row, $name, $class = '') {
	...
	switch($name) {
        ...
        case 'Distance':echo '<td' . $classAttr . '><span data-bs-toggle="tooltip" title="'.htmlspecialchars(qso_distance_tooltip($row), ENT_QUOTES, 'UTF-8').'">' . qso_format_distance($row) . '</span></td>'; break;
